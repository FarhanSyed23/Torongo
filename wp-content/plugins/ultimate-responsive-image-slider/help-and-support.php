<div class="row-fluid pricing-table pricing-three-column" style="margin-top: 10px; display:block; width:100%; overflow:hidden; background:white; box-shadow: 0 0 5px hsla(0, 0%, 20%, 0.3);padding-bottom:70px">
	...
	<div style="margin-top:30px;margin-left:30px;">
		...
		<h6 style="font-size: 18px;padding-top: 20px;padding-bottom: 10px;line-height:30px; margin-left:30px;">How to translate plguin into any language ? <br> Contact us at <em>farazfrank777@gmail.com</em>  to translate this plugin into your known language. We will guide you in better manner. And show you as language contributor on our plugin's WordPress.org page.</h6>
	</div>
	<hr>
</div>